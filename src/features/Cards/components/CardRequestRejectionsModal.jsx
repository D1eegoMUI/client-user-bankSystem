...
export const CardRequestRejectionsModal = ({ isOpen, onClose, requests = [] }) => {
    ...
    return (
        <BaseModal
            ...
            subtitle="Historial de solicitudes de tarjeta nueva rechazadas"
            maxWidth="max-w-lg"
        >
            {requests.length === 0 ? (
                <div className="py-10 text-center text-gray-400 font-medium italic text-sm">
                    No hay solicitudes de tarjeta rechazadas.
                </div>
            ) : (
