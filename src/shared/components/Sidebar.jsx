      ...
      `}>
        ...
        <div className="space-y-3 mt-8">
          <div className="px-4 py-4 bg-gray-50 rounded-2xl border border-gray-100">
            ...
            <button className="mt-3 text-[10px] bg-white border border-gray-200 w-full py-2 rounded-lg font-bold text-emerald-700 hover:bg-emerald-700 hover:text-white transition-all active:scale-95">
              Contactar
            </button>
          </div>
          <button
